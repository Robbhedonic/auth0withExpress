...
describe('Profile UI', () => {
  ...
  it('shows the given name when logged in', () => {
    const fakeUser = { given_name: 'Ada', name: 'Ada Lovelace', email: 'ada@test.com', picture: null };
  ...
  it('falls back to name if given_name is missing', () => {
    const fakeUser = { given_name: null, name: 'Ada Lovelace', email: 'ada@test.com', picture: null };
    render(<FakeProfile user={fakeUser} loading={false} />);
  ...
  it('shows the profile picture when logged in', () => {
    const fakeUser = { given_name: 'Ada', name: 'Ada Lovelace', email: 'ada@test.com', picture: 'http://img.test/pic.jpg' };
    render(<FakeProfile user={fakeUser} loading={false} />);
